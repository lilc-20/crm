...
<body>
	...
	<form id="create-tran" action="workbench/transaction/createTran.do" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单ccc">
				<input type="hidden" name="activityId" value="30c16a74de8547c5b30999d4a7b326ee">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="123">
				<input type="hidden" name="contactsId" value="c0a46e4ac2174881aa6b09f4837330b6">
			</div>
		</div>
